-- =====================================================================
-- FIX: la migración 20260605120015 (favicon) hizo CREATE OR REPLACE de
-- rpc_public_portal_by_slug copiando la versión ORIGINAL (20260530120001), lo
-- que revirtió sin querer las extensiones posteriores: latestSermons,
-- upcomingEvents, featuredProjects, latestPodcast, funds, payment_available y
-- el progreso de campañas. Resultado: el portal perdió esos contenidos y, como
-- el menú es data-driven, también los links Sermons/Events/Ministries/Podcast.
--
-- Aquí se restaura la versión COMPLETA (= 20260604120001) AÑADIENDO favicon_url.
-- =====================================================================
