-- =====================================================================
-- FASE 16 · 01 — Proyectos donables: vincular projects a fund/campaign
-- =====================================================================
-- Un proyecto/ministerio puede apuntar a un fondo o a una campaña para que el
-- portal muestre un botón "Give" que abre el formulario de donación pre-seleccionado.
...
COMMENT ON COLUMN projects.fund_id IS 'Fondo destino para el botón Give del proyecto (opcional).';
COMMENT ON COLUMN projects.campaign_id IS 'Campaña destino para el botón Give del proyecto (opcional, tiene prioridad sobre fund_id).';

-- ---------- rpc_public_projects_by_slug: exponer fund_id/campaign_id ----------
...
-- ---------- rpc_public_portal_by_slug: featuredProjects con fund_id/campaign_id ----------
